...
| 防線 | 職責 | 角色 | 台灣常見對應 |
|---|---|---|---|
| 第一道 | 業務自我管控 | 業務主管 + 第一線員工 | 各事業部、業務單位 |
| 第二道 | 風險管理與合規 | 風管、法遵、合規 | 風管處、法遵長、合規室 |
| 第三道 | 獨立保證 | 內部稽核 | 稽核室 |
| 治理層 | 監督與當責 | 董事會與審計委員會 | — |
| 外部 | 外部保證 | 會計師、主管機關 | — |
...
### 常見缺陷
- **第二道兼任第一道**：風管人員同時設計與執行業務流程 → 無獨立性
- **第三道資源不足**：稽核人力僅 2–3 人檢查數十個據點
- **升級機制斷線**：第二道發現問題後未上報審計委員會
- **形式化控制自評**：主管每月簽名但未實質查核
...
- **IPO 前 6 個月的補件陷阱**：很多公司 T-6 個月才發現治理缺漏（如關係人交易回溯、內控缺陷），此時補救影響上市時程。**建議 T-24 就啟動**
